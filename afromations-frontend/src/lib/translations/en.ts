export const en: Record<string, string> = {
  ...
  'hanna.stat.shader.value': 'Toon / Anime',
  'hanna.stat.version': 'Agent Version',
  ...
  'studio.learn.description':
    'The full pipeline: concept to 3D to character. Studio Academy teaches every step. Hana breaks down technical and creative.',
  ...
  'studio.pipeline.description':
    'Blender bpy → Anime toon shader → Eevee render → GLB/FBX export. Full pipeline from concept to deployable asset.',
  'studio.content.tag': 'Content',
  ...
  'blog.empty': 'Deploy Hana API to see live anime trends here.',
  'blog.cta.read': 'Read Full Analysis',
  'blog.cta.subscribe': 'Subscribe to Weekly Digest',

  // Gallery
  'gallery.eyebrow': 'Our Work',
  'gallery.title': 'Character Art & Scenes',
  'gallery.description':
    'Original artwork from the AFROMATIONS universe. Characters, spirits, and worlds from the DUAL series.',
  ...
  // Footer
  'footer.copyright': '© {year} AFROMATIONS Studios. Powered by Agent Hana 花',
  ...
  'about.principle3.body':
    "When you see Hana or the characters we build, you're seeing both traditions in conversation. Not erasing either. Not taking what isn't ours. Just creating together.",
  ...
  'education.description':
    'Step-by-step lessons on anime production, storytelling, and creative business. Learn from Hana and industry experts.',
  ...
  'education.footer':
    'All lessons taught by Hana + industry experts. Building this with you. No gatekeeping.',

  // DUAL-specific
  'dual.title': 'DUAL',
  'dual.subtitle': 'Seattle 2056 · Chapter 1: Knock at the Door',
  'dual.description': 'The main story of AFROMATIONS. Follow Tyshawn\'s journey in a cyberpunk Seattle where two worlds collide.',
} as const
