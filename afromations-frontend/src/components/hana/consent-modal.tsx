      ...
      <div className="relative max-w-2xl w-full mx-4 my-8">
        <div className="bg-(--af-grey) border border-(--af-red)/30 rounded-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border border-white/5 rounded-sm p-4">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-1 w-5 h-5 accent-(--af-red)"
                />
                <div className="flex-1">
                  <p className="font-semibold text-(--af-cream) mb-1">
                    Voice Recording
                  </p>
                  <p className="text-(--af-grey-light) text-sm">
            ...
            <div className="border border-(--af-red)/50 bg-(--af-red)/5 rounded-sm p-4">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="submit"
                disabled={!canSubmit}
                className="flex-1 py-3 px-4 bg-(--af-red) text-(--af-cream) font-semibold text-sm tracking-wider rounded-sm transition-colors hover:bg-(--af-red-dark) disabled:opacity-50 disabled:cursor-not-allowed"
              >
                I Agree & Continue
              </button>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/5 space-y-2">
            <p className="text-(--af-grey-light) text-xs">
