"""Rewrites Hana.agent.md cleanly, removing duplicate content and adding trigger section."""
import pathlib

p = pathlib.Path(__file__).parent.parent / ".github" / "agents" / "Hana.agent.md"
...
print(f"Written {len(NEW_CONTENT)} chars to {p}")
print("Done!")
